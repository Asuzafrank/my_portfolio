...
<template>
    <nav class="bg-black mx-auto rounded-3xl my-5 max-w-screen-lg">
        <div class="flex items-center justify-between p-5">
            <div class="flex items-center">
                <p class="text-white text-md font-bold md:hidden">*Asuza Frankline*</p>
            </div>
            <div class="navs hidden md:flex space-x-16">
                <router-link class="text-white text-sm">Home</router-link>
                <router-link class="text-white text-sm">About</router-link>
                <router-link class="text-white text-sm">Service</router-link>
        ...
        <div v-if="openMenu" class="navs md:hidden space-y-5 p-5">
            <router-link class="text-white text-sm block">Home</router-link>
            <router-link class="text-white text-sm block">About</router-link>
            <router-link class="text-white text-sm block">Service</router-link>
